...
int main(int argc, char **argv)
{
	...
	if ((sockfd = socket(AF_INET, SOCK_DGRAM, 0)) == -1)
		...
		fileName = argv[1];
				...
				setsockopt(sockfd, SOL_SOCKET, SO_RCVTIMEO, (char *)&timeSet, sizeof(struct timeval)); //Set timeout option for recvfrom
				...
				timeSet.tv_sec = 0;
				setsockopt(sockfd, SOL_SOCKET, SO_RCVTIMEO, (char *)&timeSet, sizeof(struct timeval)); //Disable timeout
